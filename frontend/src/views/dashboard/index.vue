...
const cards = [
  { title: '在职员工', value: 'employees', icon: UserOutlined, trend: '+2.3%', up: true, color: '#2F54EB' },
...
<template>
  <div class="page-container">
    <div class="page-header">
      ...
      <p class="page-subtitle">欢迎回到 HR-Agent 智能人力助手</p>
    </div>
        ...
        <Card :bordered="false" title="快捷入口">
          <div style="display: flex; flex-wrap: wrap; gap: 12px">
            <router-link v-for="item in [
              { path: '/employees', label: '员工管理', color: '#2F54EB' },
